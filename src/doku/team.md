...
* Teilnehmer: Timo, Kevin, Willi, Tobias, Tim, Lewin

1. Vorstellung Python-Client
2. Vorstellung Java-Client
3. Brainstorming: Multiplayer-Funktionen
    * Wie bleiben die Clients einheitlich?
    * Was darf sich unterscheiden?
    * Welche Daten müssen über den Server gesendet werden?
    * Wie werden Parameter und benötigte Daten berechnet?
4. Ausarbeitung des MVP-Meilensteins
5. Kanban Aktualisierung: "New" in "Brainstorming" umbenennen
6. Vorstellung Server-Kommunikation
7. Planung und Ziele für das nächste Meeting
    * Erstellung eines Leitfadens
    * Anforderungen in Issues umwandeln und mit User Storys verknüpfen
8. Formulierung offener Fragen
